...
# Whether to WRITE this data to a file each day (May increase load time however data will be saved if program crashes)
writeFileDaily = False
startingCases = 1
startingIndex = 198
...
# Assigns each person to their workplace
for person in peopleList:
